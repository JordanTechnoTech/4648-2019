...
public class ShoulderCommand extends Command {
    ...
    public ShoulderCommand(double shoulderPosition){
        ...
        SmartDashboard.putNumber("Shoulder Kp",.75);
        ...
        SmartDashboard.putNumber("Shoulder position",100);
    }

    @Override
    protected void execute() {
        double kp = SmartDashboard.getNumber("Shoulder Kp",.75);
        ...
        double dbPosition = SmartDashboard.getNumber("Shoulder position",100);
